...
namespace Erp.Modules.Sales.Infrastructure.Migrations
{
    public partial class AddCustomerInvoiceLineTaxFields : Migration
    {
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropColumn(name: "TaxRate", schema: "sales", table: "SalesOrderLines");
            migrationBuilder.DropColumn(name: "TaxAmount", schema: "sales", table: "SalesOrderLines");
        }
    }
}
