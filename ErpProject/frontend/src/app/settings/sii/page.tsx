        ...
        <div style={{ padding: '28px 32px', fontFamily: 'Inter, sans-serif' }}>
            ...
            {showPreview && preview && (
                <div className="modal-overlay" onClick={e => { if (e.target === e.currentTarget) setShowPreview(false); }}>
                    <div className="modal-box" style={{ maxWidth: '700px', maxHeight: '80vh', display: 'flex', flexDirection: 'column' }}>
                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px' }}>
                            <h2 style={{ fontSize: '16px', fontWeight: 700 }}>
                                Preview SII — {type === 'emitidas' ? 'Facturas Emitidas' : 'Facturas Recibidas'} {String(month).padStart(2, '0')}/{year}
                            </h2>
