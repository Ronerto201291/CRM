...
interface BudgetsClientProps {
  ...
  initialYearFilter: number;
}

export default function BudgetsClient({ initialBudgets, initialYearFilter }: BudgetsClientProps) {
  ...
  // solo se refetch en el cliente cuando el filtro de año cambia tras el montaje.
