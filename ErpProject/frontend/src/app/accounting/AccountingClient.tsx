...
interface AccountingClientProps {
    ...
    initialBalance: BalanceRow[];
    initialIvaSoportado: IvaSummary;
    initialIvaRepercutido: IvaSummary;
    initialLiquidacion: LiquidacionIva | null;
}
...
export default function AccountingClient({
    ...
    initialBalance,
    initialIvaSoportado,
    initialIvaRepercutido,
    initialLiquidacion,
}: AccountingClientProps) {
    const [tab, setTab] = useState<Tab>('diario');
    const [journal] = useState<JournalEntry[]>(initialJournal);
    const [balance] = useState<BalanceRow[]>(initialBalance);
    const [ivaSoportado] = useState<IvaSummary>(initialIvaSoportado);
    const [ivaRepercutido] = useState<IvaSummary>(initialIvaRepercutido);
    const [liquidacion] = useState<LiquidacionIva | null>(initialLiquidacion);
