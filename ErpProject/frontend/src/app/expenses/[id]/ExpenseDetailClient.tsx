...
interface ExpenseDetailClientProps {
    id: string;
    initialDoc: ExpenseDocumentDetail | null;
}

export default function ExpenseDetailClient({ id, initialDoc }: ExpenseDetailClientProps) {
    const [doc, setDoc] = useState<ExpenseDocumentDetail | null>(initialDoc);
