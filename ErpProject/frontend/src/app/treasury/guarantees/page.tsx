...
export default function GuaranteesPage() {
    ...
    const submit = async () => {
        if (!form.beneficiary || !form.amount) { alert('Beneficiario y monto son obligatorios'); return; }
        setSaving(true);
        try {
            ...
            {showCreate && (
                <div className="modal-overlay" onClick={() => setShowCreate(false)}>
                    <div className="modal-box" onClick={e => e.stopPropagation()} style={{ maxWidth: '500px' }}>
                        <h2 style={{ marginBottom: '16px', fontSize: '18px', fontWeight: 700 }}>Nueva Garantía</h2>
