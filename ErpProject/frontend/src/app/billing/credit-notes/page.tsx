...
export default function CreditNotesPage() {
    ...
    return (
        <PageContainer>
            ...
            {/* Modal */}
            {showModal && (
                <div className="modal-overlay" onClick={e => { if (e.target === e.currentTarget) { setShowModal(false); setSelectedInvoice(null); } }}>
                    <div className="modal-box" style={{ maxWidth: '500px' }}>
                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px' }}>
                            <h2 style={{ fontSize: '16px', fontWeight: 700, color: 'var(--text-primary)' }}>Crear Factura Rectificativa</h2>
                            <button onClick={() => { setShowModal(false); setSelectedInvoice(null); }} style={{ border: 'none', background: 'none', cursor: 'pointer', fontSize: '20px', color: 'var(--text-muted)' }}>✕</button>
                        </div>
